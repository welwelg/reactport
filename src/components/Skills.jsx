...
function SkillCard({ skill }) {
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden transition-all duration-300 bg-gray-800 border rounded-xl ${
        isActive
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center p-3 sm:p-4">
        {/* Logo Container */}
        <div className={`flex items-center justify-center w-12 h-12 mb-2 transition-transform duration-300 bg-gray-700 rounded-lg sm:w-14 sm:h-14 sm:mb-3 md:w-16 md:h-16 ${
          isActive ? 'scale-110' : ''
        }`}>
          <img 
            src={skill.image} 
...
export default function Skills() {
  return (
    <div id='skills' className="relative flex items-center justify-center min-h-screen px-3 py-8 bg-gradient-to-br from-gray-900 via-black to-gray-900 sm:px-4 md:px-6">
      {/* Background Blob Effect */}
      <div className="absolute z-0 transform -translate-x-1/2 rounded-full opacity-40 bg-orange-950 w-64 h-32 sm:w-80 sm:h-40 md:w-96 md:h-44 lg:w-[500px] lg:h-52 blur-3xl top-8 sm:top-12 md:top-20 left-1/2"></div>
      <div className="absolute z-0 w-56 transform translate-x-1/2 bg-orange-800 rounded-full h-28 opacity-30 sm:w-72 sm:h-36 md:w-80 md:h-40 blur-3xl bottom-16 sm:bottom-20 right-1/2"></div>
