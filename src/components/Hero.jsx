...
import Gallardo from '/Gallardo.pdf';
import TextType from '../reactbits/TextType';
import TrueFocus from '../reactbits/TrueFocus'
import ProfileCard from '../reactbits/ProfileCard';

export default function Hero() {
  const roleTexts = ["Fullstack Developer", "Software Engineer / Developer", "Web Designer"];
  ...
  return (
    <div className='relative flex flex-col min-h-screen overflow-hidden'>
      ...
      <main id="home" className="z-10 flex flex-col items-center justify-center flex-1 w-full gap-8 px-4 pt-20 pb-8 sm:pt-24 sm:pb-12 md:flex-row md:px-6 lg:px-12 xl:px-20 md:pb-24 md:pt-32">
        ...
        >
          ...
          <p className='mb-6 sm:mb-8 text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed min-h-[5rem]'>
            <TextType 
              text={paragraphTexts}
              typingSpeed={25}
              pauseDuration={2000}
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row md:justify-start sm:gap-6">
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              <a href="#" className="text-gray-400 transition-colors duration-200 hover:text-white hover:scale-110">
                <Github size={20} className='sm:w-6 sm:h-6' />
              </a>
              <a href="#" className="text-gray-400 transition-colors duration-200 hover:text-blue-400 hover:scale-110">
                <Linkedin size={20} className='sm:w-6 sm:h-6' />
              </a>
              <a href="#" className="text-gray-400 transition-colors duration-200 hover:text-orange-400 hover:scale-110">
        ...
        <figure data-aos='fade-up' data-aos-delay='500' className='flex items-center justify-center w-full md:flex-1'>
          <ProfileCard
            name="Wel Tech Code"
            title="Web Developer"
            handle="weltechcode"
